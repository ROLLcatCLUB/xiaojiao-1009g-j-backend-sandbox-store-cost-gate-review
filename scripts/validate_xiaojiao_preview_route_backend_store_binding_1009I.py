...
SLUG="xiaojiao_preview_route_backend_store_binding_1009I"
FINAL_STATUS="XIAOJIAO_PREVIEW_ROUTE_BACKEND_SANDBOX_STORE_BINDING_PASS"
MARKER="ALL_1009I_PREVIEW_ROUTE_BACKEND_SANDBOX_STORE_BINDING_CHECKS_OK"
REQUIRED=[
  "docs/foundation/xiaojiao_preview_route_backend_store_binding_1009I.md",
  "docs/foundation/xiaojiao_preview_route_backend_store_binding_1009I.json",
  "docs/audit/xiaojiao_preview_route_backend_store_binding_1009I_result.json",
  "docs/audit/xiaojiao_preview_route_backend_store_binding_1009I_report.md",
  "docs/audit_packages/xiaojiao_preview_route_backend_store_binding_1009I_manifest.json",
  "docs/audit_packages/xiaojiao_preview_route_backend_store_binding_1009I.zip",
  "scripts/validate_xiaojiao_preview_route_backend_store_binding_1009I.py",

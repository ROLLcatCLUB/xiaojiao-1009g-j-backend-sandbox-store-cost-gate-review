...
SLUG="xiaojiao_cost_gate_backend_store_smoke_review_1009J"
FINAL_STATUS="XIAOJIAO_COST_GATE_AND_BACKEND_STORE_SMOKE_REVIEW_PASS"
MARKER="ALL_1009J_COST_GATE_AND_BACKEND_STORE_SMOKE_REVIEW_CHECKS_OK"
REQUIRED=[
  "docs/foundation/xiaojiao_cost_gate_backend_store_smoke_review_1009J.md",
  "docs/foundation/xiaojiao_cost_gate_backend_store_smoke_review_1009J.json",
  "docs/audit/xiaojiao_cost_gate_backend_store_smoke_review_1009J_result.json",
  "docs/audit/xiaojiao_cost_gate_backend_store_smoke_review_1009J_report.md",
  "docs/audit_packages/xiaojiao_cost_gate_backend_store_smoke_review_1009J_manifest.json",
  "docs/audit_packages/xiaojiao_cost_gate_backend_store_smoke_review_1009J.zip",
  "scripts/validate_xiaojiao_cost_gate_backend_store_smoke_review_1009J.py",
